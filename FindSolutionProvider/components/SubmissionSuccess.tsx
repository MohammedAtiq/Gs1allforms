  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-1 items-center justify-center px-6 py-10">
      <section className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <h2 className="text-3xl font-bold text-gs1-blue">Application Submitted!</h2>
        ...
        <div className="mt-6 grid grid-cols-3 gap-2 rounded-xl bg-slate-50 p-3">
        ...
        <button
          ...
          className="mt-8 inline-flex h-10 items-center gap-2 rounded-md bg-gs1-blue px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-gs1-blue-dark"
        >
          <Home size={14} />
          Back to Home
        </button>
...
function Metric({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md px-1 py-1.5 text-center">
      ...
      <p className="mt-0.5 text-xl font-bold text-gs1-blue">{value}</p>
    </div>
  );
}
