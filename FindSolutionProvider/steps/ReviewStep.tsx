      ...
      <div className="mt-auto flex items-center justify-between border-t border-slate-100 pt-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-10 min-w-[148px] items-center justify-center gap-2 rounded-md bg-gs1-orange px-5 text-sm font-semibold text-white shadow-sm transition hover:brightness-95"
          >
