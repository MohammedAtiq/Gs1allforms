    ...
    >
      ...
      <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-5">
        ...
        <button
          ...
          className="inline-flex h-10 items-center gap-2 rounded-md bg-gs1-blue px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-gs1-blue-dark disabled:opacity-60"
        >
          Continue
